           ...
           <form class="container" method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data">
             @csrf <!-- CSRF protection -->
               ...
               <div class="">
                   ...
                   <input type="text" class="form-control is-valid" name="product_id" id="validationServer01"  required>
               </div>
               <div class="">
                   <label for="validationServer02" class="form-label">Product Name</label>
                   <input type="text" class="form-control is-valid" name="name" id="validationServer02"  required>
               </div>
       
               <div class="">
                 <label for="validationServer02" class="form-label">Product Details</label>
                 <input type="text" class="form-control is-valid" name="description" id="validationServer02"  required>
             </div>
       
               <div class="">
                 <label for="validationServer02" class="form-label">Price</label>
                 <input type="number" step="0.01" class="form-control is-valid" name="price" id="validationServer02"  required>
             </div>
       
             <div class="">
               <label for="validationServer02" class="form-label">In Stock</label>
               <input type="number" class="form-control is-valid" name="stock" required>
